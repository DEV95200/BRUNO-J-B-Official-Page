...
(() => {
  ...
  function initContactForm() {
    // Fonction désactivée pour permettre la soumission normale vers PHP
    // Le formulaire fonctionne maintenant avec contact.php
    return;
    
    /* Code original déplacé en commentaire pour référence
